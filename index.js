...
function countDown(){
    ...
    const segTotal = (dataLanc - hoje)/1000  //os 1000 significa milesegundos

    const finalDias = Math.floor(segTotal / 60 / 60 / 24) // Math.floor pega apenas a parte inteira dos dias
